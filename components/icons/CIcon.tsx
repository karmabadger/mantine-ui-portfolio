...
const CIcon: React.FC<SvgIconProps> = ({
  color = "#FFF",
  size = 20,
  stroke = 80,
}) => (
  ...
  >
    ...
    <path
      fill="#659ad2"
      d="M250.05 82.74 37.81 205.06a21.75 21.75 0 0 1-2.53-10.65V93.6c0-8.16 3.45-14.44 10.52-18.54C63 65.09 120.69 32 132.22 25.21c7.73-4.58 15.3-4.74 23.1-.23q43.41 25.08 86.87 50.09a20.72 20.72 0 0 1 7.86 7.67z"
    />
    <path
      fill="#fff"
